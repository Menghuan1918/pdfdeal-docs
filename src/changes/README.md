...
- Uploading MD images to image hosting now supports using path format (uploaded in the form of `/{PDF name}/{image md5}.{extension}`), [🔍View usage example](../guide/Tools/MD_imgs.md) [#53](https://github.com/Menghuan1918/pdfdeal/issues/53)
- Added a tool for converting HTML tables to Markdown format. [🔍View usage example](../guide/Tools/Html2MD.md)

### 🚀 Other
- Improved the dependencies that need to be installed
- Improved the documentation's version requirement prompts


## V0.4.9
### ✨ New Features
- Introduced a new built-in upload tool: MinIO. You can easily upload images from Markdown documents (whether online links or local links) to MinIO and replace them with links generated by MinIO. [🔍View usage example](../guide/Tools/Upload.md#minio) by [@Huxb12138](https://github.com/Huxb12138) in [#51](https://github.com/Menghuan1918/pdfdeal/pull/51)

### 🚀 Other
- Added some [example code](https://github.com/Menghuan1918/pdfdeal/tree/main/examples)
